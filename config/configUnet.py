...
class Configuration:
    ...
    def __init__(self):
        # --------- RUN NAME ---------
        # custom name for this run, eg resampled_x3, alpha60, new_train etc
        self.run_name = "UNKtest"

        # ---------- PATHS -----------
        # Modality to be preprocessed
        # choices in your project: 'MACS', 'PS', 'S2', 'aerial', ...
        self.modality = "aerial"

        # Path to training areas and polygons shapefiles
        self.training_data_dir = (
            "/isipd/projects/p_planetdw/data/dw_detection/aerial/training/aerial"
        )
        ...
        self.training_image_dir = (
            "/isipd/projects/p_planetdw/data/dw_detection/aerial/training_images/aerial"
        )

        # Output base path where preprocessed data folders will be created
        self.preprocessed_base_dir = (
            "/isipd/projects/p_planetdw/data/dw_detection/aerial/preprocessed"
        )
        ...
        # dilation rate for dilated convolutions, 1 is no dilation
        ...
        # Enable exceptions, instead of failing silently
        gdal.UseExceptions()
        # IO cache size in KB, used when warping/resampling. Higher is better.
