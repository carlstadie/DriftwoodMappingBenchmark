...
class Configuration:
    ...
    def __init__(self):
        ...
        self.split_list_path = "/isipd/projects/p_planetdw/data/methods_test/preprocessed/20260109-1434_UNETxPS/aa_frames_list.json"
        ...
        self.saved_models_dir = f"/isipd/projects/p_planetdw/data/methods_test/models/UNET/{self.modality}/run_2"
