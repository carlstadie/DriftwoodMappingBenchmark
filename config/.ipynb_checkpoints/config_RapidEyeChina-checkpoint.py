...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'RapidEye256_5bands_nonorm'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc
        ...
        #self.training_polygon_fn = 'Tree_Train_20220408.gpkg'
        
        self.training_area_fn = 'Ploygon_Train_20220228_RapidEye.shp'
        self.training_polygon_fn = 'Tree_Train_20220228_RapidEye.shp'
        
        # Path to training images
        self.training_image_dir = '/mnt/sddb/UrbanTree/RapidEye/RapidEye_UrbanRegions_Clip/IndividualCity/' #'/nfs/Planet/PlanetScope/Mosaics/Africa/2019' 

        # Output base path where all preprocessed data folders will be created
        self.preprocessed_base_dir = '/mnt/sddb/UrbanTree/RapidEye/traniningdata/'
        ...
        #self.continue_model_path = '/mnt/sddb/UrbanTree/RapidEye/Model/20221121-1537_RapidEye256_5bands_nonorm.h5'            # If set to None, a new model is created
        self.continue_model_path = None

        # Path where trained models and training logs will be stored
        self.saved_models_dir = '/mnt/sddb/UrbanTree/RapidEye/Model/'
        self.logs_dir = '/mnt/sddb/UrbanTree/RapidEye/logs/'

        # Paths to input images to be predicted
        self.to_predict_dir = '/mnt/sddb/UrbanTree/RapidEye/RapidEye_UrbanRegions_Clip/1/' #'/nfs/Planet/RapidEye/Mosaics/South_Asia/2010/not_matched'
        ...
        self.predictions_base_dir = '/mnt/sddb/UrbanTree/RapidEye/Images/RapidEye2019/merged/' # '/nfs/Users/Martin/RE/results_planet'
