...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'Mining512_nonorm'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc

        # ---------- PATHS -----------
        # Path to training areas and polygons shapefiles
        # Path to training areas and polygons shapefiles
        self.training_data_dir = '/mnt/md0/Xuemei/TrainingData/'
        self.training_area_fn = 'rectrangle_V9.shp'
        self.training_polygon_fn = 'mining_V9_2.shp'
        
         # Path to training images
        self.training_image_dir = '/mnt/md0/Planet/China/2019/'
        ...
        self.to_predict_dir = '/mnt/md0/Xuemei/planet2019/' #'/nfs/Planet/RapidEye/Mosaics/South_Asia/2010/not_matched'
        ...
        self.trained_model_path = '/mnt/md0/Xuemei/Model/saved_models/20221004-1729_test_V9.h5' # '/nfs/Users/Martin/RE/models/Planet/backup/20220530-2250_Planet_india512.h5'            # if set to None, it will use the most recent trained model
        ...
        self.prediction_stride = 448               # stride = width -> no overlap, stride = width/2 -> 50 % overlap
