...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'Mining512_NormHalf'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc

        # ---------- PATHS -----------
        # Path to training areas and polygons shapefiles
        # Path to training areas and polygons shapefiles
        self.training_data_dir = '/nfs/Users/Xuemei/2023_v1/'
        self.training_area_fn = 'Rectrangle_karst_V1_2.shp'
        self.training_polygon_fn = 'Mining_karst_V1_2.shp'
        
         # Path to training images
        self.training_image_dir = '/nfs/Planet/PlanetScope/Mosaics/China/2019/'

        # Output base path where all preprocessed data folders will be created
        self.preprocessed_base_dir = '/mnt/md0/Xuemei/preprocessed_frames/'
        ...
        self.continue_model_path = '/mnt/md0/Xuemei/Model/saved_models/20230214-0242_Mining512_NormHalf.h5'            # If set to None, a new model is created
        #self.continue_model_path = None

        # Path where trained models and training logs will be stored
        self.saved_models_dir = '/mnt/md0/Xuemei/Model/saved_models/'
        self.logs_dir = '/mnt/md0/Xuemei/Model/saved_models/logs/'

        # Paths to input images to be predicted
        self.to_predict_dir = '/nfs/Planet/PlanetScope/Mosaics/China/2019/' #'/nfs/Planet/RapidEye/Mosaics/South_Asia/2010/not_matched'
        self.to_predict_filelist = '/mnt/md0/Xuemei/Planet2021_xuemei.txt'            # [optional] path of a file with list of image paths to be predicted

        # Output path where predictions will be saved
        self.predictions_base_dir = '/mnt/md0/Xuemei/output/' # '/nfs/Users/Martin/RE/results_planet'

        # Path to model to use for this prediction [optional]
        self.trained_model_path = None #'/mnt/md0/Xuemei/Model/saved_models/20230213-0959_Mining512_nonorm.h5'            # if set to None, it will use the most recent trained model
...
# =============================================================================
        ...
        gdal.SetCacheMax(12000000000)              # IO cache size in KB, used when warping/resampling. higher is better
...
new_band = AdditionalInputBand(name="worldcover",
