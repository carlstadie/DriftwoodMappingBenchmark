...
class Configuration:
    ...
    def __init__(self):
        ...
        # self.training_area_fn = 'Ploygon_Train_20220104.shp'
        # self.training_polygon_fn = 'Tree_Train_20220104.shp'
        
        
                        # ---------- PATHS -----------
        # Path to training areas and polygons shapefiles
        self.training_data_dir = '/mnt/md0/Xuemei/prediction/'
        self.training_area_fn = 'rectrangle_V7_L_2045.shp'
        self.training_polygon_fn = 'mining_V7_L_943.shp'
        ...
        # Preprocessed frames consist of a tif file per area, with [normalised img bands + label band + boundaries band]
        ...
        self.to_predict_dir = '/mnt/md0/Xuemei/Planet_Image/'
        ...
        self.predictions_base_dir = '/mnt/md0/Xuemei/output/'

        # Path to model to use for this prediction
        ...
        self.num_validation_images = 100
        ...
        self.prediction_stride = 500              # stride = width -> no overlap, stride = width/2 -> 50 % overlap
        ...
        self.create_polygons = False                # To polygonize the raster predictions to polygon VRT
