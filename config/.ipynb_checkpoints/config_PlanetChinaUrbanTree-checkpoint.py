...
class Configuration:
    ...
    def __init__(self):
        ...
        self.training_area_fn = 'Ploygon_Train_20220408.shp'
        self.training_polygon_fn = 'Tree_Train_20220408.shp'
        
        #self.training_area_fn = 'Ploygon_Train_20220228_RapidEye.shp'
        #self.training_polygon_fn = 'Tree_Train_20220228_RapidEye.shp'
        
        # Path to training images
        self.training_image_dir = '/mnt/sddb/UrbanTree/TrainLabel_Planet_imagery/' #'/nfs/Planet/PlanetScope/Mosaics/Africa/2019' 

        # Output base path where all preprocessed data folders will be created
        self.preprocessed_base_dir = '/mnt/sddb/UrbanTree/Planet/traniningdata/'
        ...
        self.to_predict_dir = '/mnt/md0/Dataset/Global_UrbanArea_Planet/SE_Asia/' #'/nfs/Planet/RapidEye/Mosaics/South_Asia/2010/not_matched'
        ...
        self.predictions_base_dir = '/mnt/md0/Dataset/Global_UrbanArea_Planet/Prediction/' # '/nfs/Users/Martin/RE/results_planet'
