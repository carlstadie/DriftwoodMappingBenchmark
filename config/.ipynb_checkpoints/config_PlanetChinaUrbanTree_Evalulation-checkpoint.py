...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'Planet_China256_500Epoch_nonorm'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc
        ...
        self.training_polygon_fn = 'Tree_evalulation_GF_BJ.gpkg'
        
        #self.training_area_fn = 'Ploygon_Train_20220228_RapidEye.shp'
        #self.training_polygon_fn = 'Tree_Train_20220228_RapidEye.shp'
        
        # Path to training images
        self.training_image_dir = '/mnt/sddb/UrbanTree/Planet/TC_urban_1m_20220902/rename/Clip/' #'/nfs/Planet/PlanetScope/Mosaics/Africa/2019' 

        # Output base path where all preprocessed data folders will be created
        self.preprocessed_base_dir = '/mnt/sddb/UrbanTree/Evaluation_Images/Planet/'
