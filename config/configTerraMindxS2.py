...
class Configuration:
    ...
    def __init__(self):
        ...
        self.scheduler = "onecycle"            # NEW: "none" | "cosine" | "onecycle"
        ...
        self.tm_decoder_channels = 384
        self.tm_head_dropout = 0.01               # NEW: tuned "tm_head_dropout"
        ...
        self.tm_lr_backbone = 8e-06               # NEW: tuned "tm_lr_backbone"
        self.tm_lr_head_mult = 10.0              # NEW: tuned "tm_lr_head_mult"
        self.tm_weight_decay = 3e-06              # NEW: tuned "tm_weight_decay"
        ...
        # ------ GPU / ENV ------
        self.selected_GPU = 3  # CUDA device index, -1 for CPU
        gdal.UseExceptions()
